...
describe("thunks", () => {
    ...
    describe("checkoutCart with mock redux store", () => {
        it("should checkout", async () => {
            const store = mockStore({ cart: { items: { testIem: 3 } } });
    ...
    describe("checkoutCart with full redux store", () => {
        ...
        it("should handle and error response", async () => {
